...
//
//  private final Replica local = Replica.fromString("localhost:1"); //new ReplicaStub("local");
...
//            return Replica.fromString(input);
//          }
//        }));
//  }
//
...
//  }
//
////  private static class ReplicaStub extends Replica {
////
